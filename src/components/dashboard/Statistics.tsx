      ...
      <CardContent>
        ...
        {lastWeek.some(day => day.hours > 0) && (
          <div className="space-y-2 mb-6">
            ...
            <div className="h-40 sm:h-48 w-full overflow-x-auto pb-2">
        ...
        {examHours.length > 0 && (
          <div className="space-y-2">
            ...
            <div className="h-64 flex flex-col items-center overflow-x-auto">
              <div className="min-w-[300px] h-full w-full">
                <ResponsiveContainer width="100%" height="100%">
                  <PieChart>
                    <Pie
                      data={examHours}
